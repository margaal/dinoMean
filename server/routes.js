...
router.put('/dino/addfriend/:id', jwtHelper.verifyJwtToken, dinosaure.addFriend);
router.put('/dino/removefriend/:id', jwtHelper.verifyJwtToken, dinosaure.removeFriend);
